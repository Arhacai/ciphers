...
class Cipher:
    ...
    def encrypt(self, text):
        ...
        return self.split_in_blocks(self.pad_encryption(text))

    def decrypt(self, text):
        """Decryption method to be implemented on each cipher."""
        return self.pad_encryption(self.join_from_blocks(text), False)
    ...
    def pad_encryption(self, text, encrypt=True):
        ...
        - encrypt is set to True by default, so this method uses the pad to
